    ...
    <div class="scroll">
        <div class="scrollContainer">
            <div class="panel" id="aboutus">
                ...
                <div class="simple_message"> Hooray... It's done.<br/>
                    ${item} <span style="font-style: italic;">"${itemIdentity}"</span> successfully ${action}.<br/>
                    Click <a href="<c:url value='${addNewUrl}'/>"> here </a> to add a new ${item}.
